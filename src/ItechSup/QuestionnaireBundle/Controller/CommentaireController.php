...
use ItechSup\QuestionnaireBundle\Entity\Commentaire;
use ItechSup\QuestionnaireBundle\Form\CommentaireType;
...
class CommentaireController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ItechSupQuestionnaireBundle:Commentaire:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechSupQuestionnaireBundle:Commentaire')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechSupQuestionnaireBundle:Commentaire:edit.html.twig")
     */
