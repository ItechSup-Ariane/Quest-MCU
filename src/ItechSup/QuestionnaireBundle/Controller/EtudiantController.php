...
use ItechSup\QuestionnaireBundle\Entity\Etudiant;
use ItechSup\QuestionnaireBundle\Form\EtudiantType;
...
class EtudiantController extends Controller
{
     ...
     *
     * @Route("/", name="etudiant_create")
     * @Method("POST")
     * @Template("ItechSupQuestionnaireBundle:Etudiant:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechSupQuestionnaireBundle:Etudiant')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="etudiant_update")
     * @Method("PUT")
     * @Template("ItechSupQuestionnaireBundle:Etudiant:edit.html.twig")
     */
