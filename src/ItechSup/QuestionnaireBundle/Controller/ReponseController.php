...
use ItechSup\QuestionnaireBundle\Form\ReponseType;
...
class ReponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechSupQuestionnaireBundle:Reponse')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechSupQuestionnaireBundle:Reponse:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechSupQuestionnaireBundle:Reponse')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechSupQuestionnaireBundle:Reponse:edit.html.twig")
     */
